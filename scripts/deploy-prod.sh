...
echo -e " - Public site:      ${BLUE}https://challenge.charangudla.com${NC}"
echo -e " - API health:       ${BLUE}https://api.challenge.charangudla.com/health${NC}"
echo -e " - Admin dashboard:  ${BLUE}https://admin.challenge.charangudla.com${NC}"
echo -e "\n${YELLOW}First-deploy SSL:${NC} run Certbot for all four hostnames"
echo -e "           ${BLUE}sudo certbot certonly --standalone -d challenge.charangudla.com -d www.challenge.charangudla.com -d api.challenge.charangudla.com -d admin.challenge.charangudla.com${NC}"
echo -e "${GREEN}======================================================================${NC}"
